...
![Fig.S2 Empirical coverage of baselinenowcast method and real-time KIT simple nowcast at 50% and 95% prediction intervals](../output/figs/supp/bar_chart_cov_ag_rt.png){#figs5}

### German Nowcast Hub validation additional figures

![Fig.S3 Relative WIS by age group compared to KIT simple nowcast revised.](../output/figs/supp/rel_wis_by_age_group.png){#figs3}

![Fig.S4 Mean WIS by nowcast horizon for each model.](../output/figs/supp/mean_wis_by_horizon_ag.png){#figs4}

![Fig.S5 Relative WIS by nowcast horizon compared to KIT simple nowcast revised.](../output/figs/supp/rel_wis_by_horizon_ag.png)

![Fig.S6 Empirical coverage at 50% and 95% prediction intervals](../output/figs/supp/bar_chart_cov_ag.png){#figs6}

![Fig.S7 Empirical coverage at 50% and 95% prediction intervals by horizon for each model.](../output/figs/supp/cov_by_horizon_ag.png){#figs7}

![Fig S8. Empirical coverage at 50% and 95% prediction intervals by age group for each model configuration.](../output/figs/supp/cov_by_age_group.png){#figs8}
...
![Fig S13. Absolute WIS over time (by week) for each model.](../output/figs/supp/wis_over_time_noro.png){#figs13}

![Fig S14. Relative mean delay over time by weekday](../output/figs/supp/rel_mean_delay_over_time_noro.png){#figs14}

![Fig S15. Empirical coverage at 50% and 90% prediction intervals for each model.](../output/figs/supp/noro_coverage.png){#figs15}

![Fig S16. Empirical coverage at 50% and 90% prediction intervals by day of week for each model.](../output/figs/supp/noro_cov_wday.png){#figs16}
