...
sum_scores |>
  ...
  mutate(rel_wis = wis / default_wis) |>
  select(model_variation_string, rel_wis, age_group) |>
  filter(model_variation_string == "Weekday filter") |>
  kable(caption = "Model permutations Weekday filter: relative scores by age group")
...
sum_scores |>
  ...
  kable(caption = "Model permutations: weekday filter min and max scores by age group")
```
